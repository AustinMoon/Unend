       ...
       <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="http://quickcorrections.com/qc/login3/user/payment"><i class=""></i><h5 style="margin-top:-2px; margin-bottom:-5px">Arabic</h5></a>
                        </li>
	...
	<main id="site-content" role="main">
        ...
        <div id= "page-wrapper"class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i>Arabic Special</i></h3>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
      ...
      <?php echo form_open_multipart('user/arabic_proofreading');?> 
                ...
                <div class= "row">
                    ...
                    <h5 style="color:#918C8C"> </h5>
                         ...
                         <h4><i><hr/>Step 2. Let us know if you need anything! (e.g due date etc).</i></h4>
